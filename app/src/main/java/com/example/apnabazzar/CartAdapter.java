...
public class CartAdapter extends RecyclerView.Adapter {
    ...
    class CartItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public CartItemViewHolder(@NonNull View itemView) {
            ...
            coupenRedeemptionBody=itemView.findViewById(R.id.tv_coupen_redemption);
        ...
        {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.ic_baseline_filter_hdr_24)).into(productImage);
            ...
            if (inStock) {
                ...
                ////////////////// coupen dialog
                ImageView toggleRecyclerView = checkCoupenPriceDialog.findViewById(R.id.toogle_recyclerview);
                ...
                applyOrRemoveContainer=checkCoupenPriceDialog.findViewById(R.id.apply_or_remove_btns_container);
                        ...
                        if (!TextUtils.isEmpty(cartItemModelList.get(position).getSelectedCoupenId())) {
                            for (RewardModel rewardModel : DBqueries.rewardModelList) {
                                if (rewardModel.getCoupenId().equals(cartItemModelList.get(position).getSelectedCoupenId())) {
                                    ...
                                    coupenRedemptionLayout.setBackground(itemView.getContext().getResources().getDrawable(R.drawable.reward_gradient_bg));
                ...
                removeCoupenBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        coupenRedemptionLayout.setBackgroundColor(itemView.getContext().getResources().getColor(R.color.coupenRedeemorange));
                ...
                if (!showDeleteBtn) {
                    if (qtyError) {
                        ...
                        //productQuantity.setCompoundDrawableTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.Failurered)));
                            ...
                            public void onClick(View v) {
                                if (!TextUtils.isEmpty(quantityNo.getText())) {
                                    if (Long.valueOf(quantityNo.getText().toString()) <= maxQuantity && Long.valueOf(quantityNo.getText().toString()) != 0 ) {
                                                                                        ...
                                                                                        if (task.isSuccessful()) {
                                                                                            ...
                                                                                            for (String qtyId : qtyIds) {
                                                                                                ...
                                                                                                if (!serverQuantity.contains(qtyId)) {
                                                                                                    ...
                                                                                                    Toast.makeText(itemView.getContext(), "Sorry ! all products may not be available at this time", Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(itemView.getContext(),"Please check the quantity no. ",Toast.LENGTH_SHORT).show();
                                    }
                                }
                                    quantityDialog.dismiss();
                            }
                ...
                productPrice.setTextColor(itemView.getContext().getResources().getColor(R.color.Failurered));
                cuttedPrice.setText("");
