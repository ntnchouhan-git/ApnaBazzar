...
public class OrdersDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(OrdersDetailsActivity.this);
        ...
        //ordercancel dialog
        cancelDialog = new Dialog(OrdersDetailsActivity.this);
       ...
       // cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        switch (model.getOrderStatus()){
            case "Ordered":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.Ratinggreen)));
        ...
        if (model.isCancellationRequested()){
            ...
            cancelOrderBtn.setTextColor(getResources().getColor(R.color.Failurered));
